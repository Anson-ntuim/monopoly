...
export const BOARD_SPACES: Partial<Space>[] = [
  ...
  { id: 5, name: '台鐵', type: SpaceType.STATION, price: 2000, rent: [250, 500, 1000, 2000] },
  ...
  { id: 15, name: '高鐵', type: SpaceType.STATION, price: 2000, rent: [250, 500, 1000, 2000] },
  ...
  { id: 25, name: '捷運', type: SpaceType.STATION, price: 2000, rent: [250, 500, 1000, 2000] },
  ...
  { id: 35, name: '客運', type: SpaceType.STATION, price: 2000, rent: [250, 500, 1000, 2000] },
